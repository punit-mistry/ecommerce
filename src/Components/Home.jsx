  ...
  return (
    ...
    <div className='flex flex-row w-full h-[90vh] p-10'>
        <div className='w-1/2  font-serif flex flex-col justify-between   p-5'>
            ...
            <button className='bg-blue-800 text-white w-44 h-14 rounded-lg font-bold hover:bg-blue-400 transition duration-1000 hover:text-black'> Show More </button>
            </div>
        </div>
        <div className='w-1/2 flex justify-center items-center bg-green-200 shadow-xl  rounded-xl'>
                <img src={image} className=' h-full  hover:translate-y-20 ease-out transition-all duration-1000'  />
            </div>
